...
public class Word2Vector {
    public static void main(String[] args) {
        try {
            ...
            //FileInputFormat.addInputPath(job1, new Path("/Input/text.txt"));
            ...
            FileOutputFormat.setOutputPath(job1, new Path("s3n://ass003/Step1"));
            ...
            if(c1.getValue()>0) {
                ...
                FileInputFormat.addInputPath(job2, new Path("s3n://ass003/F"));
                //FileInputFormat.addInputPath(job2, new Path("/Step1/Features-r-00000"));
                FileOutputFormat.setOutputPath(job2, new Path("s3n://ass003/Step2"));
                ...
                //MultipleInputs.addInputPath(job3, new Path("s3n://ass003/Step1/SortedCorpus-r-00000"),TextInputFormat.class,Vector4.MapperClass.class);
                //MultipleInputs.addInputPath(job3, new Path("/Step1/SortedCorpus-r-00000"),TextInputFormat.class,Vector4.MapperClass.class);
                //MultipleInputs.addInputPath(job3, new Path("s3n://ass003/Step2"),TextInputFormat.class,Vector4.MapperClass.class);
                FileInputFormat.addInputPath(job3, new Path("s3n://ass003/S"));
                //FileInputFormat.addInputPath(job3, new Path("/Step1/SortedCorpus-r-00000"));
                //FileInputFormat.addInputPath(job3, new Path("/Step2"));
                FileOutputFormat.setOutputPath(job3, new Path("s3n://ass003/Step3"));
                //FileOutputFormat.setOutputPath(job3, new Path("/Step3"));
                ...
                FileInputFormat.addInputPath(job4, new Path("s3n://ass003/Step3"));
                //FileInputFormat.addInputPath(job4, new Path("/Step3"));
                ...
                //FileOutputFormat.setOutputPath(job4, new Path("/Step4"));
